...
RUN mkdir -p /etc/twitch_gameserver/db_data
RUN chmod 755 /etc/twitch_gameserver/db_data
WORKDIR "/app"
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/twitch_gameserver ./
